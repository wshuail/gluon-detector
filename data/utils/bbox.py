...
__all__ = ['bbox_crop', 'flip', 'resize', 'translate', 'random_crop_with_constraints']
...
def translate(bbox, x_offset=0, y_offset=0):
    ...
    bbox[:, :2] = bbox[:, :2] + (x_offset, y_offset)
    bbox[:, 2:4] = bbox[:, 2:4] + (x_offset, y_offset)
    return bbox
