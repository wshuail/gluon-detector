...
def encode_box_target(box_targets, anchors, means=(0., 0., 0., 0.),
...
def decode_box_target(box_preds, anchors, means=(0., 0., 0., 0.),
                      stds=(0.1, 0.1, 0.2, 0.2)):
...
def decode_retinanet_result(box_preds, cls_preds, anchors, nms_thresh=0.45,
    ...
    bboxes = decode_box_target(box_preds, anchors, means, stds)
